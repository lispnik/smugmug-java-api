 ...
 */
package com.kallasoft.smugmug.api.json.v1_2_0;

import com.kallasoft.smugmug.api.json.v1_2_0.images.Upload;
import com.kallasoft.smugmug.api.json.v1_2_0.images.UploadFromURL;
...
public class APIVersionConstants {
	/**
	 * Used to define a String representing the 1.2.0 version of the SmugMug
	 * API.
	 */
	public static final String VERSION = "1.2.0";

	/**
	 * Used to define the SmugMug API 1.2.0 secure (HTTPS) server URL that can
	 ...
	 */
	public static final String SECURE_SERVER_URL = "https://api.smugmug.com/hack/json/1.2.0/";

	/**
	 * Used to define the SmugMug API 1.2.0 unsecured (HTTP) server URL that can
	 * be used to execute any method. The request and response to and from
	 ...
	 */
	public static final String UNSECURE_SERVER_URL = "http://api.smugmug.com/hack/json/1.2.0/";
	 ...
	 * as the picture will not be stored anywhere.
	 */
	public static final String TEXT_UPLOAD_SERVER_URL = "http://upload.smugmug.com/hack/json/1.2.0/";
}
