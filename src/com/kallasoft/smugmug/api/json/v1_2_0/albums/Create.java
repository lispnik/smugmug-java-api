...
/**
 * This method will create an album in the specified category (identified by the
 * CategoryID) with the specified Title.
 * <p>
 * The session must be established with a valid login. Optionally, other
 * arguments may be specified that adjust specific album properties.
 * <p>
 ...
 * @version 1.2.0
 * @see <a
 *      href="http://smugmug.jot.com/WikiHome/1.2.0/smugmug.albums.create">smugmug.albums.create
 *      API Doc</a>
 */
public class Create extends AbstractMethod {
	 ...
	 */
	public static final String METHOD_NAME = "smugmug.albums.create";

	/**
	 * Defines all the arguments this method takes.
	 * <p>
	 * Values are: "APIKey", "SessionID", "Title", "Description", "Keywords",
	 * "CategoryID", "SubCategoryID", "Geography", "AlbumTemplateID", "EXIF",
	 * "Clean", "Header", "Filenames", "TemplateID", "SortMethod",
	 * "SortDirection", "Position", "SquareThumbs", "Password", "PasswordHint",
	 * "Protected", "Public", "HideOwner", "External", "SmugSearchable",
	 * "WorldSearchable", "Larges", "XLarges", "X2Larges", "X3Larges",
	 * "Originals", "Watermarking", "WatermarkID", "Share", "CanRank",
	 * "Comments", "FamilyEdit", "FriendEdit", "CommunityID", "Printable",
	 * "ProofDays", "Backprinting", "DefaultColor", "UnsharpAmount",
	 * "UnsharpRadius", "UnsharpThreshold", "UnsharpSigma"
	 */
	public static final String[] ARGUMENTS = { "APIKey", "SessionID", "Title",
			"Description", "Keywords", "CategoryID", "SubCategoryID",
			"Geography", "AlbumTemplateID", "EXIF", "Clean", "Header",
			"Filenames", "TemplateID", "SortMethod", "SortDirection",
			"Position", "SquareThumbs", "Password", "PasswordHint",
			"Protected", "Public", "HideOwner", "External", "SmugSearchable",
			"WorldSearchable", "Larges", "XLarges", "X2Larges", "X3Larges",
			"Originals", "Watermarking", "WatermarkID", "Share", "CanRank",
			"Comments", "FamilyEdit", "FriendEdit", "CommunityID", "Printable",
	...
	public Create(String methodName, String[] arguments) {
		...
		logger.trace("Created {} instance", this);
	}

	/**
	 * Used to execute the smugmug.albums.create method, creating a new album
	 * with the given settings and returning the album's ID.
	 * 
	 * @param url
	 ...
	 * 
	 * @return the response that includes the new album's ID.
	 */
	 ...
	 * @param title
	 *            The title of the newly created album.
	 * @param categoryID
	 *            The ID of the category that the newly created album will
	 *            belong to.
	 * 
	 * @return the response that includes the new album's ID.
	 * 
	...
	/**
	 * Class used to represent the response for the smugmug.albums.create method
	 * call.
	 * 
	 * @author Riyad Kalla
	 * @version 1.2.0
	...
	public class CreateResponse extends AbstractResponse {
		 ...
		 * 
		 * @return the security key for the album that was created.
		 */
