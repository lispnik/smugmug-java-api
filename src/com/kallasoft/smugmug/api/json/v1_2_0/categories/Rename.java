 ...
 * @version 1.2.0
 * @see <a
 *      href="http://smugmug.jot.com/WikiHome/1.2.0/smugmug.categories.rename">smugmug.categories.rename
 *      API Doc</a>
 */
public class Rename extends AbstractMethod {
	 ...
	 * <p>
	 * Values are: "APIKey", "SessionID", "CategoryID", "Name"
	 */
	...
	/**
	 * Used to execute the smugmug.categories.rename method, renaming the given
	...
	/**
	 * Convenience method used to execute the smugmug.categories.rename method,
	 * renaming the given category with the given name.
	 * <p>
