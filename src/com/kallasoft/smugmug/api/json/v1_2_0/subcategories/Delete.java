 ...
 * @version 1.2.0
 * @see <a
 *      href="http://smugmug.jot.com/WikiHome/1.2.0/smugmug.subcategories.delete">smugmug.subcategories.delete
 *      API Doc</a>
 */
public class Delete extends AbstractMethod {
	 ...
	 */
	public static final String METHOD_NAME = "smugmug.subcategories.delete";

	/**
	 * Defines all the arguments this method takes.
	 * <p>
	 * Values are: "APIKey", "SessionID", "SubCategoryID"
	 */
	...
	/**
	 * Used to execute the smugmug.subcategories.delete method, deleting the
	 * given subcategory.
	 * 
	 * @param url
	...
	/**
	 * Convenience method used to execute the smugmug.subcategories.delete
	 * method, deleting the given subcategory.
	 * <p>
	...
	/**
	 * Class used to represent the response for the smugmug.subcategories.delete
	 * method call.
	 * 
	 * @author Riyad Kalla
	 * @version 1.2.0
