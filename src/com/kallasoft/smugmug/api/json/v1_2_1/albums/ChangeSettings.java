...
public class ChangeSettings extends
	...
	public ChangeSettingsResponse execute(String url, String apiKey,
			String sessionID, Long albumID, String title,
			String description, String keywords, Long categoryID,
			Long subCategoryID, Boolean geography, Long albumTemplateID,
			Boolean exif, Boolean clean, Boolean header, Boolean filenames,
			Long templateID, String sortMethod, Boolean sortDirection,
			Integer position, Long highlightID, Boolean squareThumbs,
			...
			Boolean originals, Boolean watermarking, Long watermarkID,
			Boolean share, Boolean canRank, Boolean comments,
			Boolean familyEdit, Boolean friendEdit, Long communityID,
