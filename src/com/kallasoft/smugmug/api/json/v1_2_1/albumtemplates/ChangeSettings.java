...
/**
 * This method will change the settings on an album template specified by
 * AlbumTemplateID.
 * <p>
 ...
 * @version 1.2.1
 * @see <a
 *      href="http://smugmug.jot.com/WikiHome/1.2.1/smugmug.albumtemplates.changeSettings">smugmug.albumtemplatess.changeSettings
 *      API Doc</a>
 */
public class ChangeSettings extends AbstractMethod {
	 ...
	 */
	public static final String METHOD_NAME = "smugmug.albumtemplates.changeSettings";

	/**
	 * Defines all the arguments this method takes.
	 * <p>
	 * Values are: "APIKey", "SessionID", "AlbumTemplateID",
	 * "AlbumTemplateName", "Geography", "EXIF", "Clean", "Header", "Filenames",
	 * "TemplateID", "SortMethod", "SortDirection", "Password", "PasswordHint",
	...
	public static final String[] ARGUMENTS = { "APIKey", "SessionID",
			"AlbumTemplateID", "AlbumTemplateName", "Geography", "EXIF",
			"Clean", "Header", "Filenames", "TemplateID", "SortMethod",
			"SortDirection", "Password", "PasswordHint", "Protected", "Public",
			"HideOwner", "External", "SmugSearchable", "WorldSearchable",
			"Larges", "XLarges", "X2Larges", "X3Larges", "Originals",
			"Watermarking", "WatermarkID", "Share", "CanRank", "Comments",
			"FamilyEdit", "FriendEdit", "CommunityID", "Printable",
			"ProofDays", "Backprinting", "DefaultColor", "UnsharpAmount",
			"UnsharpRadius", "UnsharpThreshold", "UnsharpSigma" };
	...
	/**
	 * Used to execute the smugmug.albumtemplates.changeSettings method,
	 * changing any settings specified and leaving any settings not specified as
	 * they are.
	 * 
	 * @param url
	...
	/**
	 * Convenience method used to execute the
	 * smugmug.albumtemplates.changeSettings method.
	 * <p>
	 ...
	 *            The ID of the album template to apply the changes to.
	...
	public ChangeSettingsResponse execute(String url, String apiKey,
		...
		return execute(url, new String[] { apiKey, sessionID,
				APIUtils.toString(albumTemplateID), albumTemplateName,
				APIUtils.toString(geography), APIUtils.toString(exif),
				...
				APIUtils.toString(position), password, passwordHint,
	 ...
	 * smugmug.albumtemplates.changeSettings method call.
	 * <p>
