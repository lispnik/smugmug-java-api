 ...
 * {@link com.kallasoft.smugmug.api.json.v1_2_0.categories.Create}
 * implementation.
 * 
 * @author Riyad Kalla
 * @version 1.2.1
 * @see com.kallasoft.smugmug.api.json.v1_2_0.categories.Create
 */
public class Create extends
		com.kallasoft.smugmug.api.json.v1_2_0.categories.Create {
	/**
	...
	/**
	 * This class is a convenience class extending the base
	 * {@link com.kallasoft.smugmug.api.json.v1_2_0.categories.Create.CreateResponse}
	 * implementation.
	 * 
	 * @author Riyad Kalla
	 * @version 1.2.1
	 * @see com.kallasoft.smugmug.api.json.v1_2_0.categories.Create.CreateResponse
	 */
	public class CreateResponse
			extends
			com.kallasoft.smugmug.api.json.v1_2_0.categories.Create.CreateResponse {
