 ...
 * {@link com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash} implementation.
 * 
 * @author Riyad Kalla
 * @version 1.2.1
 * @see com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash
 */
public class WithHash extends
		com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash {
	/**
	...
	/**
	 * This class is a convenience class extending the base
	 * {@link com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash.WithHashResponse}
	 * implementation.
	 * 
	 * @author Riyad Kalla
	 * @version 1.2.1
	 * @see com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash.WithHashResponse
	 */
	public class WithHashResponse
			extends
			com.kallasoft.smugmug.api.json.v1_2_0.login.WithHash.WithHashResponse {
